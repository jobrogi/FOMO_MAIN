...
function Header(){
    ...
    return(
        <div className=" w-full sticky top-0 bg-dark-background">
            {/* Top Menu with search bar and hamburger icon */}
            <ul className="flex items-center justify-center">
                <li className="flex w-1/4 justify-center">
                    <button onClick={()=>{headerMenuActive(!headerMenu)}}><i className="fa-solid fa-bars text-3xl text-dark-text"></i></button>
                </li>
                {/* <li>
                ...
                <li className="m-5 w-full flex flex-nowrap">
                    ...
                    <button className="w-16 bg-dark-accent-1 placeholder-white text-dark-text h-8 text-center rounded-e-xl text-md decoration"><i className="fa-solid fa-magnifying-glass"></i></button>
            ...
            <div className="absolute top-0 left-0 w-screen h-screen z-20"> 
                ...
                <button className="w-screen h-screen" onClick={()=>{headerMenuActive(!headerMenu)}} ></button>
                ...
                <div className="bg-dark-background w-3/4 h-screen absolute top-0 z-30 shadow-2xl shadow-black flex flex-col flex-wrap justify-start p-2">
                    <div className="flex w-full flex-nowrap h-fit justify-between items-center">
                        <ul className="w-3/4 h-fit">
                            <li>
                                <div className="text-dark-text text-4xl font-bold hover:cursor-pointer text-center w-full h-fit">F.O.M.O</div>
                            </li>
                        </ul>
                        <button className="h-fit w-fit" onClick={()=>{headerMenuActive(!headerMenu)}}><i className="h-fit fa-solid fa-bars text-3xl text-dark-text float-left"></i></button>
                    </div>
                    ...
                    <ul className="flex flex-wrap w-full justify-center mt-8 ">
                        ...
                        <li className="text-xl text-dark-text w-full text-center p-2"><button>Home</button></li>
                        <li className="text-xl text-dark-text w-full text-center p-2"><button>Profile</button></li>
                        <li className="text-xl text-dark-text w-full text-center p-2"><button>Settings</button></li>
