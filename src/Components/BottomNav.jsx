  ...
  return (
    <div className="min-h-fit w-full bottom-0 left-0 fixed">
      <div
        className={
          active === true
            ? "flex flex-wrap bg-black w-full fixed bottom-0 px-4 pb-2 transition-all duration-200"
            : "flex flex-wrap bg-gradient-to-b from-transparent to-gray-900 w-full fixed bottom-0 px-4 pb-4 pt-1 transition-all duration-200 translate-y-16"
        }
      >
        ...
        <div
          className={
            active === true
              ? "flex justify-center items-baseline w-full"
