...
function SignUpButton(props){
    ...
    return(
        <div>
          <button onClick={()=>{setFormSection(1)}} className={props.button} >Sign Up</button>
          <button value="Close" onClick={SetFormSection} className={formSection === 0 ? "" : "backdrop-blur fixed top-0 left-0 w-screen h-screen"}></button>
            
            <div className={formSection === 1 ? "fixed top-0 left-0 bg-black p-2 w-full" : "hidden"}>
                <form method="POST" id="SignUp" className="w-full h-fit pointer-events-auto">
                    <div>
                        <p className="p-2 text-2xl text-dark-text">Sign Up 1/2</p>
                        <button type="button" value="Close" onClick={SetFormSection} className="text-dark-text absolute top-0 right-0 p-2">X</button>
                    </div>
                    <hr />
                    <p className="p-4 mb-2 text-dark-text">No Information will be shown or shared publicly. Your information is only used for security purposes.</p>

                    <div className="border-2 flex flex-wrap justify-center p-2">
                        <h1 className="bg-black text-dark-text px-3 -mt-5 w-fit">First and Last Name</h1>
                        <div className="flex flex-nowrap w-full">
                            <input type="text" id="fName" className="p-3 mb-2 m-1 w-1/2 outline-none text-dark-text" placeholder="First Name" />
                            <input type="text" id='lName' className="p-3 mb-2 m-1 w-1/2 outline-none text-dark-text" placeholder="Last Name" />
                        </div>
                    </div>
                    ...
                    <div className="border-2 flex flex-wrap justify-center p-2 mt-4">
                        ...
                        <input type="email" id='email' className="p-3 mb-2 m-1 w-full outline-none text-dark-text" placeholder="Email Address" />
                    </div>

                    <div className="border-2 flex flex-wrap justify-center p-2 mt-4">
                        <h1 className="bg-black text-dark-text px-3 -mt-5 w-fit">Date of Birth</h1>
                        <input type="date" id="dob" className="p-3 mb-2 m-1 w-full outline-none text-dark-text" placeholder="Email Address" />
                    </div>
            ...
            <div action="POST" form="SignUp" className={formSection === 2? "fixed top-0 left-0 bg-black p-2 w-full": "hidden"}>
                <div>
                ...
                <p className="mt-2 mb-1 text-center font-bold text-dark-text">Username & Password Tips</p>
