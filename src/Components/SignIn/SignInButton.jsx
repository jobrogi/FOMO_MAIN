...
function SignInButton(props){
    ...
    const { setIsAuthenticated, setUser, setCurrentPage } = React.useContext(AuthContext);
    ...
    return(
        <div>
          <button onClick={()=>{setFormSection(1)}} className={props.button}>Sign In</button>
          <button value="Close" onClick={SetFormSection} className={formSection === 0 ? "" : "backdrop-blur fixed top-0 left-0 w-screen h-screen"}></button>
                    ...
                    <div className={formSection === 1? "justify-center":"hidden"}>
                        ...
                        <form method="POST" id="signIn" className="w-full h-fit pointer-events-auto ">
                            <div className="border-2 flex flex-wrap justify-center p-2">
                                <h1 className="bg-black text-dark-text px-3 -mt-5 w-fit"><i className="fa-brands fa-google me-1"></i> Sign in with Google</h1>
                        ...
                        <div className="border-2 flex flex-wrap justify-center p-2 mt-4">
                            ...
                            <div className="flex items-center justify-center relative w-full p-0 m-0">
                              <input id="_password" type="password" className="p-3 mb-2 m-1 w-full outline-none text-black pointer-events-auto auto" placeholder="Enter Password" />
                            </div>
                        ...
                        <div className="flex flex-nowrap pointer-events-auto">
                            <button form="SignIn" type="submit" onClick={handleLogIn} className="w-full bg-dark-accent-1 p-2 mt-2 m-2 rounded-lg">Submit</button>
                        </div>
            ...
            <div className={formSection === 2? "bg-black fixed top-0 w-full h-fit z-40 left-0 ": "hidden"}>
